...
<nav><a href="#categorias">Categorias</a><a href="#vendidos">Mais vendidos</a>${promo.length ? '<a href="#sale">Sale</a>' : ''}<a href="#marca">A marca</a></nav>
...
<p style="margin-top:24px">© ${new Date().getFullYear()} ${esc(cliente.nome)}. Todos os direitos reservados.</p></div></footer>
...
<button class="btn" id="finalizar" data-checkout-slot>Finalizar compra</button><p class="nota">Pagamento feito no checkout seguro do provedor escolhido.</p></div></aside>
